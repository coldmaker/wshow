...
class Page {
    ...
    public function show() {
        ...
        if ($upRow>0){
            ...
            $upPage     =   "<li class='disabled'><a href='".str_replace('__PAGE__',$upRow,$url)."'>".$this->config['prev']."</a></li>";
        }

        if ($downRow <= $this->totalPages){
            $downPage   =   "<li><a href='".str_replace('__PAGE__',$downRow,$url)."'>".$this->config['next']."</a></li>";
        }else{
            $downPage   =   "<li class='disabled'><a href='".str_replace('__PAGE__',$downRow,$url)."'>".$this->config['next']."</a></li>";
        }
        // << < > >>
        if($nowCoolPage == 1){
            $theFirst   =   '';
        ...
        for($i=1;$i<=$this->rollPage;$i++){
            ...
            if($page!=$this->nowPage){
                ...
                if($this->totalPages != 1){
                    $linkPage .= "<li class='active'><a href='#'>$page<span class='sr_only'></span></a></li>";
                }
            }
        }
        $pageStr     =   str_replace(
